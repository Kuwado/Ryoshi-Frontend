...
const Carousel = ({slideData}) => {
    ...
    return (
        <div className='carousel-container'>
            <div className="slide">
                <div className="slide-inner" style={{ transform: `translateX(-${currentSlide * 100}vw)` }}>
                    {slideData.map((slide) => (
                        <div key={slide.id} className={`slide-item ${slide.id === slideData[currentSlide].id ? 'active' : ''}`}>
                ...
                <a className="next-btn-container" onClick={goToNextSlide} role="button">
                    <div className="next-btn" aria-hidden="true">
                        <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="50" height="50" rx="25" fill="#0094DA" fill-opacity="1"/>
                        <path d="M37.4262 23.735C38.4107 24.7112 38.4107 26.2966 37.4262 27.2728L22.3058 42.2678C21.3214 43.2441 19.7228 43.2441 18.7384 42.2678C17.754 41.2916 17.754 39.7062 18.7384 38.7299L32.079 25.5L18.7462 12.2701C17.7618 11.2938 17.7618 9.70841 18.7462 8.73218C19.7306 7.75594 21.3293 7.75594 22.3137 8.73218L37.4341 23.7272L37.4262 23.735Z" fill="#FAFAFA" fill-opacity="1"/>
                        </svg>
                    </div>
